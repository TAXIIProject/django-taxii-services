...
# THIS IS NOW IMPLEMENTED ON THE MODEL
# def service_to_service_instances(taxii_service):
    ...
    # for pb in taxii_service.supported_protocol_bindings.all():
        # si = tm11.ServiceInstance(
                     ...
                     # available = taxii_service.enabled,
